...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyannote.metrics-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13662&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyannote.metrics-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyannote.metrics` can be installed with:

```
conda install pyannote.metrics
```

It is possible to list all of the versions of `pyannote.metrics` available on your platform with:
